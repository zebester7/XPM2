...
import { User, Review, Question } from './types';
import { db } from './db';
...
const HireTeacherPage = lazy(() => import('./pages/HireTeacherPage'));
const SyllabusPrecisionPage = lazy(() => import('./pages/SyllabusPrecisionPage'));
const StudyGroupsPage = lazy(() => import('./pages/StudyGroupsPage'));
const TeacherDirectoryPage = lazy(() => import('./pages/TeacherDirectoryPage'));
const PaymentPage = lazy(() => import('./pages/PaymentPage'));
const TeacherRegistrationPage = lazy(() => import('./pages/TeacherRegistrationPage'));
