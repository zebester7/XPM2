    ...
    <div className="bg-slate-50 min-h-screen">
      <section className="bg-xpm-blue py-24 lg:py-32 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <span className="inline-block px-4 py-1.5 bg-white/10 text-white rounded-full text-xs font-black uppercase tracking-widest mb-6 border border-white/10">Premium Tutoring</span>
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto font-medium leading-relaxed">
            Move beyond self-study. Hire XPM expert tutors for personalized lesson plans and guaranteed academic growth.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 pb-24 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2 space-y-12">
            <div className="bg-white p-12 lg:p-16 rounded-[3rem] shadow-2xl shadow-slate-200/50 border border-slate-100">
              <h3 className="text-3xl font-black text-slate-900 mb-12 tracking-tight">Why Hire XPM Tutors?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                <div className="space-y-4">
                  ...
                  <p className="text-slate-500 font-medium leading-relaxed text-sm">Every student learns differently. We tailor our teaching speed to your comfort level.</p>
                </div>
                <div className="space-y-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-10 rounded-[3rem] shadow-2xl border-4 border-xpm-blue/5 sticky top-24">
              ...
              <div className="space-y-8">
                ...
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Specific Requirements</label>
                  <textarea 
                    rows={3}
