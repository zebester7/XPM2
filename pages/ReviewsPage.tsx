...
const ReviewsPage: React.FC<ReviewsPageProps> = ({ user, reviews, onAddReview }) => {
  ...
  useEffect(() => {
    ...
    updatePageMeta({
      ...
      description: 'Read real reviews from students who have improved their grades with XPM Tutors. See success stories and ratings from our community.',
      keywords: 'student reviews, testimonials, ratings, feedback, XPM Tutors',
    ...
    if (reviews.length > 0) {
      ...
      const reviewSchema = {
        ...
        'review': reviews.slice(0, 10).map(review => ({
          ...
          'datePublished': new Date(review.timestamp).toISOString().split('T')[0],
          'reviewRating': {
            '@type': 'Rating',
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
          {reviews.map(review => (
            <div key={review.id} className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm relative overflow-hidden group" itemScope itemType="https://schema.org/Review">
              ...
              <meta itemProp="datePublished" content={new Date(review.timestamp).toISOString().split('T')[0]} />
              ...
              <div className="flex justify-between items-start mb-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h4 className="font-bold text-slate-900" itemProp="author">{review.userName}</h4>
              ...
              <p className="text-slate-600 leading-relaxed italic" itemProp="reviewBody">"{review.comment}"</p>
