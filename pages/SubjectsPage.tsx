  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-10 text-center">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">Explore our high-quality study materials for major international examination boards including Federal Board Grades 9-12.</p>
      </div>
