...
const HomePage: React.FC<{ reviews: Review[] }> = ({ reviews }) => {
  ...
  return (
    <div className="bg-white overflow-x-hidden">
      ...
      {/* Floating Icon to Healing Mind Page */}
      <Link
        to="/mishal-razzaq"
        className="fixed right-6 bottom-6 z-40 w-16 h-16 rounded-full shadow-2xl hover:shadow-xl transition transform hover:scale-110 flex items-center justify-center text-3xl"
        style={{ backgroundColor: '#0F5C4D', color: '#F8F5EE' }}
        title="The Healing Mind: Islam & Mental Wellness"
      >
        🧠
      </Link>
